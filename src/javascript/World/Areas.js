...
export default class Areas
{
    ...
    setMouse()
    {
        ...
        // Mouse click — desktop only. On touch devices the touchend handler in Area.js
        // covers all interactions; the synthetic mousedown that follows a tap would double-fire.
